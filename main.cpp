...
//int main() {
//    //int argc, char** argv)
//    std::string prompt = "Hello Motherfuckers";
//    std::cout<< prompt << std::endl;
//
//    Line line (2.2,3.3);
//    //std::cout<<line.f(5.5)<<std::endl;
//
//    float variance;
//    float covariance;
//    float xArray[12] = {178,172,186,180,171,163,175,179,175,178,182,173};
//    float yArray[12] = {170,174,188,188,170,170,175,178,175,178,164,163};
//
//    variance = var(xArray,12);
//    std::cout<<variance<<std::endl;
//    //covariance = cov(xArray,yArray,12);
//    //std::cout<<"the covariance is:"<<covariance<<std::endl;
//    return 0;
//}
